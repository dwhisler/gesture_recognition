...
bool test3() {
  ...
  Quaternion invExp = Quaternion(0.066418, -0.068493, -0.107929, -0.002076);
  ...
  inv.serialPrint();
  Serial.println();
  return quaternionNear(inv, invExp);
}

/* setFromAngleAxis() */
bool test4() {
  Quaternion q0 = Quaternion();
  q0.setFromAngleAxis(2, 1 / sqrt(14), 2 / sqrt(14), 3 / sqrt(14));
